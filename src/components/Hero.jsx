export default function Hero() {
  return (
    <section className="min-h-[819px] flex items-center justify-center py-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto relative" id="home">
      ...
      {/* CAPA DEL FONDO*/}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-primary-container/10 via-background to-background z-0"></div>

      {/* CAPA DE CONTENIDO: relative z-10 para estar por encima del destello */}
      <div className="w-full grid md:grid-cols-12 gap-gutter relative z-10">
        <div className="md:col-span-8 flex flex-col items-start justify-center">
          ...
          <div className="flex gap-4">
            ...
            <a aria-label="GitHub" className="btn-secondary-custom px-4 py-4 rounded flex items-center justify-center" href="https://github.com/damianriollo-HLH" target="_blank" rel="noreferrer">
